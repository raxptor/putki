...
public class PropertyEditor implements Editor
{
	...
	public boolean canEdit(Compiler.ParsedStruct tp)
	{
		return true;
	}

	public Node createUI(DataObject object)
	{
		...
		HBox desc = new HBox();
		Label path = new Label("Editing [" + object.getPath() + "] (" + object.getType().moduleName + " - " + object.getType().name + ")");
		Button save = new Button("Save");
		save.setOnAction( (actionEvent) -> {
			Main.s_dataWriter.WriteObject(object);
			actionEvent.consume();
		});
